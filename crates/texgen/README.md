...
| `cliff-stone` | fractured stone averaging to the shader's cliff grey, up is up on the face | a few large slabs from one Voronoi, elongated shards from a finer one inside shattered slabs, edges with their own width and depth that fade into solid rock, tone and level drifting across the face, leaning top-lit faces, facets, spalls, pits, drip staining, moss in deep cracks, hairline fractures, grit, equalize, mean pin, grain |

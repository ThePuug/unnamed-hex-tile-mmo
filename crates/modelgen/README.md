...
| `deciduous-tree` | one broadleaf tree, bare trunk under a lumpy crown as wide as the tile and taller than wide, near twice a person's height | six-sided tapered trunk over a root flare, a limb to each ring lump, crown of six or seven icospheres (centre, a ring of four or five at scattered heights, one on top) each squashed and noise-lumped, scaled to the seed's width and crown height, two leaf greens alternating around the ring, a slight lean |

...
ADR-014 intentionally simplified the haven system for combat prototyping:

| # | Spec Says | Implementation | Rationale |
|---|-----------|----------------|-----------|
| 1 | Three starter havens (Mountain/Prairie/Forest) | Single haven at origin (0,0) | Simplified MVP for combat testing |
| 2 | Influence radius system (1000 pop, 3000 tile radius) | Distance-based difficulty (100 tiles per level, 0-10) | No hub/influence dependencies yet |
| 3 | Biome-placed havens at 7000+ tile spacing | Directional archetype zones (N/E/S/W) | Provides spatial variety without world gen |
| 4 | Haven services (vendors, crafting) | Not implemented | Deferred to full haven system |

## Implementation Gaps

**Critical for launch:** Three distinct havens at fixed coordinates, indestructible property mechanics, haven placement (7000+ spacing)

**Medium:** Tutorial sieges (small waves, always survivable), territory zone system (full influence-based), basic starter services

**Blocked by other systems:** Hub system (influence, population), Siege system (encroachment, anger), world generation (biome placement)

**Current state:** ADR-014 MVP foundation complete — single haven respawn, distance-based difficulty, directional zones, UI feedback. Full haven system deferred pending hub/siege implementation.

---

**Related Design Documents:**
- [Hub System](hubs.md) — Hub tiers, influence, merging mechanics
- [Siege System](siege.md) — Siege mechanics driven by encroachment and anger

...
**Impact:** ~350 lines eliminated across 7 abilities (60 lines x 7 - 70 lines pipeline overhead).
...
- ~350 lines eliminated across 7 abilities (60 duplicated x 7 - 70 pipeline)

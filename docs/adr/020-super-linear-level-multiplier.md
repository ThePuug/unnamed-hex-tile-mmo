...
Additionally, reaction windows should reward level advantage: a high-level defender fighting low-level threats should have more time to react, reflecting experience and skill superiority.
...
| Damage / Offense | 0.15 | 1.5 | 1.00 | 1.84 | 2.76 |
...
- HP scales moderately (k=0.10, p=1.5): danger should persist even at high levels
- Damage scales moderately (k=0.15, p=1.5): balanced with HP growth to preserve level advantage without exponential runaway
- Reaction stats scale gently (k=0.10, p=1.2): human reaction time has natural limits

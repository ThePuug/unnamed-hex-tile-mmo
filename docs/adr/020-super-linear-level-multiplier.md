...
**References:**
- [Combat Balance Design Doc](../design/combat-balance.md) — Full formula reference
- [ADR-005: Derived Combat Stats](005-derived-combat-stats.md) — Existing linear derivation
- [Attribute System Spec](../design/attributes.md) — Attribute definitions
...
- [Combat Balance Design Doc](../design/combat-balance.md)
- [ADR-005: Derived Combat Stats](005-derived-combat-stats.md)
- [Attribute System Spec](../design/attributes.md)

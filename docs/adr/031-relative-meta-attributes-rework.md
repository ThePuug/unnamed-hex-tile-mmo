...
This was a transitional state from Phase 4, which established the contest framework but did not complete the mechanical implementation.
...
4. **Opposition mismatch**: The relative oppositions (Grace↔Vitality, Might↔Focus, Presence↔Instinct) didn't align with the design intent for emergent opposition through independent stats

## Decision

We adopt the relative meta-attribute system with the following implementation specifics:
